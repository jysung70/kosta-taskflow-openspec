...
- [x] 10.1 Vercel 계정 연결 및 프로젝트 생성
- [x] 10.2 Neon DB 프로비저닝 및 DATABASE_URL 환경변수 Vercel에 등록
- [x] 10.3 vercel deploy 실행 및 배포 URL 확인
- [x] 10.4 배포 환경에서 회원가입→로그인→팀생성→칸반→채팅 전체 플로우 수동 확인
